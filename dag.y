...
%token <str> ID ADD SUB MUL DIV ASSIGN LP RP MOD OS CS IF WHILE LEQ LT GEQ GT ELSE EQ NEQ SEMI AND OR OB CB NOT
%type <str> E array whileStmt ifStmt assign Stmt relOp cond
%start S
%%
...
block : OB {
		...
		Stmt CB
      | assign | ifStmt | whileStmt
      ;

Stmt : assign Stmt| ifStmt Stmt | whileStmt Stmt
     |
     ;
