...
{
  "$end", "error", "$undefined", "ID", "ADD", "SUB", "MUL", "DIV",
  "ASSIGN", "LP", "RP", "MOD", "oneD", "twoD", "'+'", "'-'", "'*'", "'/'",
...
{
      -1,    -5,     4,     8,    -7,    -7,     8,     8,    -7,    26,
      26,    18,     8,     8,     8,     8,     8,    -7,    26,    26,
      26,    26,    26
};
...
{
      10,    11,     1,     3,     4,     0,    18,    19,    20,    21,
      22,     5,     0,     6,     0,     0,     0,     7,     0,     0,
       0,     8,    12,    13,    14,    15,     0,     0,    17,    16,
      12,    13,    14,    15,     0,     0,     0,    16
};

static const yytype_int8 yycheck[] =
{
       6,     7,     3,     8,     0,    -1,    12,    13,    14,    15,
      16,     3,    -1,     5,    -1,    -1,    -1,     9,    -1,    -1,
      -1,    13,     4,     5,     6,     7,    -1,    -1,    10,    11,
       4,     5,     6,     7,    -1,    -1,    -1,    11
};
...
{
       0,     3,    21,     8,     0,     3,     5,     9,    13,    22,
      22,    22,     4,     5,     6,     7,    11,    10,    22,    22,
      22,    22,    22
};
...
#line 80 "yacc.y" /* yacc.c:1646  */
    {char temp[100]; gencode((yyvsp[-2].str),'+',(yyvsp[0].str),temp); strcpy((yyval.str),temp);}
...
#line 85 "yacc.y" /* yacc.c:1646  */
    {char temp[100]; gencodeUnary('-',(yyvsp[0].str),temp); strcpy((yyval.str),temp);}
...
#line 89 "yacc.y" /* yacc.c:1646  */
    {char temp[100]; printf("hi\n"); gencodefor2D((yyvsp[0].str),temp); strcpy((yyval.str),temp);}
